...
- S1 wheel center used in drawing/calculation: `X -131.636, Y +76.000`
- This center keeps the S1 wheel arc passing through chuck center `(0, 0)` with radius `152 mm`, following the 60 degree direction shown in the reference drawing.
